...
export async function uploadProductImage(file: File, productId: string) {
  try {
    // Skip bucket existence check as the bucket is already confirmed to exist
    /*
    ...
    if (!bucketExists) {
      console.error(`Storage bucket "${bucketName}" does not exist. Please create it in the Supabase dashboard.`);
      return null;
    }
    */
